...
public class HorseRacingGame extends JFrame {
    ...
    private void placeBet(int winnerHorse) { // this method tells the user whether their bet was correct or not
        try {// all of these statements check if input is correct or whether their bet was
             // any good
    ...
    private void updateProgress(int horseIndex, int position) {// this method is called in the startrace method and used
                                                               // to update the position of the horses.
